...
Revision ID: 3815086eebc9
Revises: 
Create Date: 2019-11-07 20:41:14.877091
...
def upgrade():
    ...
    sa.Column('userEmail', sa.String(length=220), nullable=True),
    sa.Column('machineId', sa.Integer(), nullable=True),
    sa.Column('machineNumber', sa.Integer(), nullable=True),
    ...
    sa.Column('cycleComplete', sa.String(length=120), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
